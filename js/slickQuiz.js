(function($){
    ...
    $.slickQuiz = function(element, options) {
        ...
        var defaults = {
            checkAnswerText:  'Periksa Jawaban',
            nextQuestionText: 'Selanjutnya &raquo;',
            ...
            setupQuiz: function() {
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        questionHTML.append('<div class="questionCount">Pertanyaan ke <span class="current">' + count + '</span> dari <span class="total">' + questionCount + '</span></div>');
